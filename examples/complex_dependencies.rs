...
fn main() {
    ...
    let user_profile = engine.reserve(async {
    ...
    let friends_list = engine.reserve(async move {
    ...
    let user_posts = engine.reserve(async {
    ...
    let aggregated = engine.reserve(async move {
    ...
    let notifications = engine.reserve(async {
    ...
    let dashboard = engine.reserve(async move {
